var $ZSIQChatWindow = $ZSIQChatWindow || function() {
    var S, l, a, h = 0, s = document.documentElement.scrollTop || document.body.scrollTop, u = {
        1: "siq_rht",
        2: "siq_rht",
        3: "siq_lft",
        4: "siq_lft",
        ...
        if (S.className = S.className.replace(/(?:^|\s)siqhide(?!\S)/, "").replace(/(?:^|\s)siqanim(?!\S)/, ""),
        e) {
            if (!$ZSIQUtil.getIframe())
                return w(),
                void $ZSIQChatWindow.populateIframe(function() {
                    p(e)
                });
            ...
            S.className += " siqanim",
            $ZSIQChatWindow.setLoadContentClass(),
            r();
            var t = $ZSIQUtil.getIframe().ZSIQTranscript;
            t && t.scroll("", "", !0)
        }
        !function(e) {
            if (window._IS_REVAMP && $ZSIQWidgetUI.isHandHeldDevice() && document.getElementById("siqiframe").contentDocument.documentElement.setAttribute("device", "mobile-device"),
            $ZSIQWidgetUI.isHandHeldDevice() && $ZSIQWidgetUI.isAppleDevice()) {
                var t = document.body
                  , i = document.documentElement;
                if (t.className = (t.className || "").replace(/(?:^|\s)zsiq_fixedlayout(?!\S)/, ""),
                !e)
                    return i.scrollTop = s,
                    t.scrollTop = s;
                s = i.scrollTop || t.scrollTop,
                t.className += " zsiq_fixedlayout"
            }
        }(e)
    }, f = function() {
        S.style.top = "-10000px",
        ...
        void 0 === a && (a = 0),
        clearTimeout(a),
        $ZSIQUtil.storeCookieVal(e, t, i),
        a = setTimeout(function() {
            n(e, t, i)
        }, 12e4)
    }, w = function() {
        $ZSIQWidgetUI.addClass($ZSIQChatWindow.getChatWindowDiv(), "siq_showload"),
    ...
    return {
        ...
        constructIframe: function(e, t) {
            if ($ZSIQCookie.get("isiframeenabled") && !$ZSIQChatWindow.getChatWindowDiv() || !$ZSIQChatWindow.isTrackingOnly() || $ZSIQChat.isPreview()) {
                var i, a = $ZSIQWidget.getEmbedObject(), s = $ZSIQWidget.getWidgetObject(), n = !1, o = $ZSIQChat.isPreview(), r = window._IS_REVAMP, l = $ZSIQUtil.getIframe().$Support, d = $zohosq.nonce, c = null != s.isSeasonalThemeEnabled ? s.isSeasonalThemeEnabled : $ZSIQChat.isSeasonalTheme();
                if (c = c && r && !$ZSIQChatWindow.isBotChatPreview(),
                S && !_WINDOW_REPOPULATE && (o ? n = !0 : (S.remove(),
                _WINDOW_REPOPULATE = !1)),
                n || (S && S.remove(),
                (S = document.createElement("DIV")).innerHTML = '<div id="siqcht" class="zls-prelative" ><iframe id="siqiframe" title="SalesIQ Chatwindow" seamless="seamless" height="460" width="100%" scrolling="no"></iframe></div>',
                ...
                S.className = function() {
                    ...
                    i += $ZSIQChat.isPreview() ? "" : "zsiq-mobhgt ",
                    i += $ZSIQChatWindow.isNewHeader() ? "zsiq-newtheme " : "",
                    i += !$ZSIQChatWindow.isOnlyCall() || t || window._IS_REVAMP ? "" : "zsiqdircall ",
                    i += $ZSIQWidgetUI.isHandHeldDevice() ? "mobile-device " : "",
                    i += window._IS_REVAMP && t ? " bot-preview " : "";
                    var a = " zsiq_size" + $ZSIQWidget.getEmbedSize();
                    return $ZSIQChat.isSignatureChat() ? i + a : i + u[$ZSIQWidgetUI.getWidgetPosition()] + a
                }(),
                S.setAttribute("embedtheme", a.theme),
                S.setAttribute("data-id", "zsiqembed"),
                c ? S.setAttribute("seasonal-type", $ZSIQChat.getSeasonalThemeObj().type) : S.removeAttribute("seasonal-type"),
                d && S.setAttribute("nonce", d),
                n)
                    !r && l.init($ZSIQWidget.getEmbedObject());
                else if (function() {
                ...
                }() || t || 0 == $zohosq.fileloadtime && $ZSIQWidgetUI.F_WINDOW == $ZSIQWidgetUI.getWidgetState())
                    ...
                    m && "show" == m && (I = 0,
                    r && $ZSIQChatWindow.populateIframe(t)),
                ...
                !function(e) {
                    ...
                    i ? $ZSIQChatWindow.handleChatWindowVisible(i, e) : $ZSIQWidgetUI.getWidgetState() != $ZSIQWidgetUI.F_WINDOW ? f() : (w(),
                    $ZSIQChatWindow.populateIframe(),
                    p(!0))
                }(e),
                l && l.Util && l.Util.handleResize && l.Util.handleResize(),
                (i = $ZSIQUtil.getCookieValue("dragpos")) && (i = JSON.parse(i),
                S.setAttribute("style", "left:" + i.left + ";top:" + i.top)),
                this.handleESCEvent()
            }
        },
        populateIframe: function(t, i) {
            if (document.getElementById("siqiframe"))
                S.className = S.className.replace(/(?:^|\s)siq_showload(?!\S)/, "");
            else {
                !window._IS_DEV && function() {
                    ...
                    if (iscdnenabled && !$ZSIQChat.isPreview()) {
                        var t = $zohosq.nonce
                          , i = {};
                        i[SIQ_FLOAT] = "/salesiq/styles/floatbuttonpostload_Pa0WG0fin4SjrnBZjHin5vP3GQC_Nv9XqLM6KV_i-I5DsoInRo88Uwa8oyhuF8bR_.css",
                        i[SIQ_BUTTON] = "/salesiq/styles/buttonthemepostload_z-0zW6ewSp67MQ2RFCD3Sbq0lUcYdQiQTqJHTBe3Wfn2-Z-8JBJ4k9V0feEm6lC-_.css",
                        i[SIQ_PERSONALIZE] = "/salesiq/styles/personalizethemepostload_sLci-XVkHeGTpJncovl4VnwEuWaeUXDvpRK1R-OHriuPdFUR-4GrZBgko_ZeNum3_.css";
                        var a = e.widgetobj
                        ...
                        $ZSIQChat.notifyOnCDNFailure(I, g, (o + i[e.widgettype]).replace(/WIDGTHEME/g, s), "css"),
                ...
                var e = document.getElementById("siqiframe")
                  ...
                  , n = function() {
                    ...
                    var e = $ZSIQUtil.getIframe().$Support;
                    e && !_IS_REVAMP && (e.handleStatusCallback(),
                    e.handleAudioCallback()),
                    function() {
                    ...
                    S.className = S.className.replace(/(?:^|\s)siq_showload(?!\S)/, ""),
                    i && i(),
                    $ZSIQUtil.idetifyVisitorData(),
                    IframeHandler.loadExternalFiles(),
                    r()
                };
                if (window._IS_REVAMP) {
                    ...
                    var o = function() {
                        ...
                        s.forEach(function(e) {
                            $zohosq.nonce && e.setAttribute("nonce", $zohosq.nonce),
        ...
        handleIframeLoading: function(e) {
            !$ZSIQChatWindow.getChatWindowDiv() && $ZSIQChatWindow.isTrackingOnly() ? ($ZSIQCookie.set("isiframeenabled", !0, 864e5, !0),
            $ZSIQChatWindow.constructIframe(!1, e)) : e && e()
        },
        ...
        RemoveLoadingForTrigger: function() {
            $ZSIQChatWindow.getChatWindowDiv() && $ZSIQChatWindow.getChatWindowDiv().classList.remove("siq_showload"),
            delete $ZSIQUTSAction.widget_interaction,
            clearTimeout($ZSIQChatWindow.triggerloader)
        },
        ...
        openChatWindow: function(e, t, i) {
            ...
            S.hasAttribute("drag") || (S.style.top = ""),
            $ZSIQWidgetUI.isCSSTransformSupported() ? (p(!0),
            $ZSIQUTSAction.widget_interaction && (w(),
            $ZSIQChatWindow.triggerloader = setTimeout(function() {
            ...
            if ($ZSIQWidgetUI.setWidgetState($ZSIQWidgetUI.F_WINDOW),
            IframeHandler.sendPostMessage("iframestate", !0),
            $ZSIQUtil.getIframe().$Support) {
                ...
                n.getUnreadCount() && !n.isConversationUIFocussed() && (n.sendReadCall(),
                n.removeUnreadCookie(),
                $ZSIQWidgetUI.removeUnreadCount()),
                $ZSIQUtil.getIframe().$UI && !$ZSIQChat.isPreview() && setTimeout(function() {
                    $ZSIQUtil.getIframe().$UI.handleComponentFocus(),
                    $ZSIQUtil.startChatwindowOnload()
                }, 500)
            }
        },
        forceOpenChatWindow: function() {
            $ZSIQUtil.getIframe().$Support.getParent().$ZSIQWidgetUI.removeCallClass(),
        ...
        expandChatWindow: function() {
            ...
            "-10000px" == S.style.top && (S.style.top = ""),
            $ZSIQWidgetUI.isCSSTransformSupported() ? p(!0) : S.style.display = "block",
            $ZSIQWidgetUI.setWidgetState($ZSIQWidgetUI.F_WINDOW)
        },
        closeChatWindow: function(e) {
            $ZSIQUtil.stopBlinking(),
            e ? $ZSIQChat.isOnboarding() && $ZSIQWidget.handleCallBacks({
                "floatwindow.minimize": ""
            }) : $ZSIQWidget.handleCallBacks({
                "chat.close": ""
            }),
            p(),
            S.className = S.className.replace(/(?:^|\s)remtrans(?!\S)/, ""),
            IframeHandler.sendPostMessage("iframestate", !1);
            try {
                var t = $ZSIQUtil.getAPIValues()
                  , i = $ZSIQUtil.getIframe().$Support
                  , a = i.isChatExist() ? i.getRecentLiveChatid() : -1;
                if ("hide" == t.floatvisible && (t.customhtml || -1 == a))
                    return void $ZSIQWidgetUI.setWidgetState(-1 != a && null != a ? $ZSIQWidgetUI.F_BUTTON : $ZSIQWidgetUI.F_STICKER)
            } catch (e) {}
            ...
            if (!$ZSIQChat.isPreview()) {
                if (!$ZSIQUtil.getIframe().$Support.isChatExist()) {
                    ...
                    if (e) {
                        ...
                        a && (t.status && a[0] ? i = a[0][0] || i : !t.status && a[1] && (i = a[1][0] || i)),
                        e.innerHTML = $ZSIQUtil.getEncodedText(i)
                    }
                }
                $ZSIQChat.getWidgetData().widgettype == SIQ_PERSONALIZE && $ZSIQLSDB.remove("ZLDPERSONALIZE"),
                ...
                $ZSIQUtil.isCHatwindowMinimized = !0,
        ...
        handleChatWindowVisible: function(e, t, i, a, s) {
            if ($ZSIQChatWindow.isBotChatPreview())
                $ZSIQChatWindow.openChatWindow(!0);
            else if (!t)
                if (!0 !== $ZSIQWidget.getWidgetObject().hideembed) {
                    var n = $ZSIQUtil.getAPIValues().floatwindowvisible;
                    s = s || n,
                    (e = e || n) && ("hide" != e || $ZSIQWidgetUI.getWidgetState() != $ZSIQWidgetUI.F_WINDOW && !$ZSIQChat.isPreview() ? "show" == e ? ($ZSIQChatWindow.openChatWindow(!1, a, s),
                    i && !$ZSIQUtil.getIframe().$Support.isChatExist() && $ZSIQUtil.getIframe().$Support.openClassicUI()) : !isNaN(e) && 0 < e && setTimeout($ZSIQChatWindow.openChatWindow, 1e3 * e, s) : $ZSIQChatWindow.closeChatWindow(!0))
                } else
        ...
        handleDrag: function(e) {
            ...
            return cx = t.offsetLeft - parseInt(i[0]),
            cy = t.offsetTop - parseInt(i[1]),
            cx = cx < 0 ? 0 : cx,
            cy = cy < 0 ? 0 : cy,
            cx = cx + s > o ? o - s : cx,
            cy = cy + n > r ? r - n : cy,
        ...
        cacheChatDivPosition: function() {
            var e = S.style;
            "" === e.left || $ZSIQWidgetUI.isHandHeldDevice() || (e.removeProperty("transition"),
            S.setAttribute("drag", "true"),
            n("dragpos", '{"left":"' + e.left + '", "top":"' + e.top + '" }', !0))
        },
        isOfflineByEngaged: function() {
            for (var e = $ZSIQWidget.getEmbedObject().einfo.embedstatus.DEPTLIST, t = 0; t < e.length; t++) {
                var i = e[t];
                if (!i.STATUS && i.ENGAGED)
                    return !0
            }
            return !1
        },
        ...
        getStaticFileNodes: function(e, t, i) {
            for (var a = [], s = "js" === t, n = window._IS_DEV, o = 0; o < e.length; o++)
                if (s) {
                    ...
                    r.src = e[o],
                    i && !n ? r.type = "module" : n || (r.type = "nomodule"),
                    a.push(r)
                } else {
        ...
        getRevampWindowVariables: function(e, t) {
            var i, a = e.einfo, s = t.commondata, n = t.widgetobj, o = {
            ...
            return r.textContent = "window._STATIC_URL='" + _STATIC_URL + "';window._CONFVARIABLES=" + JSON.stringify(o) + ";",
            r
        },
        ...
        splitFileHashAndGetSRIattr: function(e) {
            if (!(($ZSIQChat.getWidgetData() || {}).embedobj || {}).subresourceintegrity_enabled)
                return "";
        ...
        getFiles: function() {
            ...
            i.cssstaticfile = "/styles/embedtheme" + t.theme + ".css",
            i.jsstaticfile = "/js/siqchatwindow" + t.theme + ".js";
            var c = i.resourcefile
              , I = !1;
            try {
                parent.WixPopUp && (I = !0)
            } catch (e) {}
            if (iscdnenabled && (i.cssstaticfile = "/salesiq/styles/embedtheme" + t.theme + "_" + cssjslist[i.cssstaticfile] + "_.css",
            i.jsstaticfile = "/salesiq/js/siqchatwindow" + t.theme + "_" + cssjslist[i.jsstaticfile] + "_.js"),
            $ZSIQChatWindow.isNewHeader()) {
                var g = t.jquery_version_updated;
                i.cssstaticfile = t.isRtlLang ? "/salesiq/styles/embedrtl_vFQdZ1ggDTRQcz1Q4N_-qYYD-obmPpu6PugiiPNBh9DXEGeENcC0ySv26LBmGB2p_.css" : "/salesiq/styles/newembedtheme_7nMmFo0ESIxWpUGdpIA_Gji1F1wXJfgzxXqzov8GXJfF87FZxcjEP__h96HoqdCb_.css",
                i.jsstaticfile = g ? "/salesiq/js/siqnewchatwindow1_QoHJlCqd0sz5FBWOqOmKd8LSQ0ONnAbKbNpfvcI1g96llJdbZGNM_Q0v11-p-bzo_.js" : "/salesiq/js/siqnewchatwindow_72P21g5lRmeCG4Xn0-lOVbx7zHe-JodXRnyG6vSyXuQ3fzSXujV8Fe5yQpESE9K0_.js"
            }
            if ($ZSIQChat.isPreview() && !I) {
                ...
                l = m ? "" : '<link href="' + h + '" rel="stylesheet" type="text/css" />',
                l += '<script src="' + S + '"><\/script>'
            }
            if (t.ucomp) {
                var u = $zohosq.nonce ? 'nonce ="' + $zohosq.nonce + '"' : ""
                  , p = n.jscdnstaticserver + "/salesiq/js/embedmedia-rtc_vtfwEm43f7qXG-Pb03VoFaBFNBy-Lx9xRDoSys_CNSczEevu1EKUyb09l0wLeXOT_.js";
                ...
                w && (f = "integrity=" + w + ' crossorigin="anonymous"'),
                s += '<script src="' + i.wmsjsstaticserver + '" ' + u + " " + f + '><\/script><script src="' + n.jscdnstaticserver + i.jsstaticfile + '" ' + u + $ZSIQChatWindow.splitFileHashAndGetSRIattr(i.jsstaticfile) + ' ><\/script><script src="' + c + '"  onerror="' + d + '" ' + u + $ZSIQChatWindow.splitFileHashAndGetSRIattr(c) + " ><\/script>" + l + "</head><body></body></html>",
                t.einfo.embedstatus.staticfiles_delayloading_enabled || (s += '<script src="' + p + '" ' + u + $ZSIQChatWindow.splitFileHashAndGetSRIattr(p) + " ><\/script>")
            } else {
                t.theme,
                t.theme,
                t.theme;
                $ZSIQChatWindow.isNewHeader() && ("themeui.js",
                "themetemplate.js",
                "theme.css",
                "themecommon.css"),
                s = Filedatagetter.getIframeFileData({
                    iframecls: o,
                    preview_files: l
                })
            }
            try {
                ...
                if (1 == $[0] && $[1].fpath) {
                    ...
                    if ("undefined" != typeof $ZSIQChat && $ZSIQChat.getWidgetData().usedownloadserver) {
                        ...
                        s += '<link href="' + r + "/" + t.screenname + "/" + v + '/stylesheet.ls" rel="stylesheet" type="text/css" />'
                }
            } catch (e) {}
            return s
        },
            ...
            if (e) {
                ...
                if (t) {
                    var i = $ZSIQWidget.getWidgetObject()
                      ...
                      , s = e[1];
                    s[a + ".html"] && (t.innerHTML = s[a + ".html"]),
                    e[2] || ($ZSIQUtil.bindClickEvent(t, function() {
                        $zoho.ld.handle.customClick(a)
                    }, !0),
                    e[2] = !0),
                    i.hideembed && (t.style.display = "none")
                }
            }
        },
        ...
        startChat: function(e) {
            ...
            if (i) {
                ...
                $ZSIQChat.getWidgetData().embedobj.triggerOnChatnow && i.checkAndHandleTriggerOnRestart("", !0),
                i.isCallForm = !1,
                i.Util.showMessageAreaUI(s),
                t.$("#conv-tab").addClass("sel"),
                t.$("#faqtab").removeClass("sel")
            }
        },
        ...
        isChatExist: function() {
            try {
                var e = $ZSIQUtil.getIframe().$Support;
                if (e && (e.getTriggerCookie() || e.isChatExist()))
                    return !0
            } catch (e) {}
            return !1
        },
        ...
        setLoadContentClass: function() {
            try {
                var e = $ZSIQUtil.getIframe().$Support
                  , t = e.container[0].parentNode;
                -1 != t.className.indexOf("loadframe") || !$ZSIQChat.isPreview() && -1 == S.className.indexOf("siqanim") || (t.className += " loadframe",
...
function zsiqdrag(e) {
    ...
    function c(e) {
        ...
        if (i < 0 || a < 0)
            return i < 0 && (l.style.left = "0px"),
            a < 0 && (l.style.top = "0px"),
            d = !1,
            void window.removeEventListener("mousemove", c);
        var s = parseInt(t.getPropertyValue("right")) || 0
          , n = parseInt(t.getPropertyValue("bottom")) || 0;
        if (s < 0 || n < 0)
            return s < 0 && (l.style.left = i + s + "px"),
            n < 0 && (l.style.top = a + n + "px"),
            d = !1,
            void window.removeEventListener("mousemove", c);
        l.style.left = e.pageX - o + "px",
        l.style.top = e.pageY - r + "px"
    }
...
$ZSIQTemplate.theme1 = {
    getFloatStickerHTML: function(i) {
        ...
        $ZSIQWidgetUI.getWidgetDiv().setAttribute("seasonal-type", $ZSIQChat.getSeasonalThemeObj().type));
...
var $ZSIQWidgetUI = $ZSIQWidgetUI || function() {
    var I, t, g, l, c, u = {
        ...
        left: "5",
        right: "11"
    }, m = ["1", "2", "3", "4", "5", "6", "7", "9", "10"], n = function(e) {
        var t = $ZSIQUtil.getAPIValues()
          , i = $ZSIQWidget.getWidgetObject()
          ...
          , l = "maintitle" == e ? 0 : 1
          , o = t.buttontexts;
        return o && (n && o[0] ? s = o[0][l] || s : !n && o[1] && (s = o[1][l] || s)),
        $ZSIQUtil.getEncodedText(s)
    }, S = function(e) {
        ...
        var t;
        if (e.status = (t = $ZSIQWidget.getWidgetObject()).call_status || t.status,
        e.sticker[0] != $ZSIQUtil.STATUS_DISABLE)
            return g.style.height = "",
            g.style.width = "",
            I = $ZSIQTemplate["theme" + e.sticker[1].default],
            e.clogo_src = $ZSIQUtil.getCompanyLogo(e.clogo_src),
            I.getFloatStickerHTML(e);
        ...
        "offline" == t && $ZSIQUtil.isEmpty(e.sticker[1][t]) ? (i = e.sticker[1].online,
        n = "grayscl") : i = e.sticker[1][t];
    ...
    return {
        ...
        initWidgetState: function() {
            ...
            $ZSIQWidgetUI.F_WINDOW == e && "hide" == $zohosq.values.floatwindowvisible && ($ZSIQWidgetUI.setWidgetState($ZSIQWidgetUI.F_BUTTON),
            e = $ZSIQWidgetUI.F_BUTTON),
            l = e || $ZSIQWidgetUI.F_STICKER
        },
        ...
        drawWidget: function() {
            var e = $ZSIQWidget.getWidgetObject()
              ...
              , n = !!g
              , a = $zohosq.nonce;
            if (n || (g = document.createElement("DIV")),
            g.className = f(e) + i,
            g.innerHTML = S(h(e)),
            g.setAttribute && (g.setAttribute("data-id", "zsalesiq"),
            a && g.setAttribute("nonce", a)),
            n || (g.style.visibility = "hidden",
            document.body.appendChild(g)),
            !$ZSIQChat.isPreview()) {
                var s = t.pinfo.pinfo
                  , l = document.getElementById("gdprbanner");
                if (null != l && l.remove(),
                1 == JSON.parse(s.isgdprenabled) && 0 != JSON.parse(s.trackingprivacyconfig) && 1 == e.isgdprenabled && !$ZSIQUtil.checkGDPRBannerStatus(0, null, t)) {
                    (c = document.createElement("DIV")).innerHTML = $ZSIQUtil.getGDPRBanner(e, s),
                    c.className = "gdbr-banner-cont";
                    ...
                    $ZSIQUtil.bindEventsCookieBanner()
                }
            }
            if (e.onlysticker)
                try {
                ...
                $ZSIQWidgetUI.bindCustomCSS(e),
                $ZSIQUtil.bindClickEvent(g, $ZSIQWidgetUI.handleFloatEvents),
                n || $ZSIQUtil.bindClickEvent(document, $ZSIQUtil.stopBlinking),
                ...
                $ZSIQUtil.bindResizeEvent($ZSIQWidgetUI.handleResizeEvents),
                t.is_widget_drag_supported && !$ZSIQChat.isPreview() && $ZSIQWidgetUI.bindDragEvent(),
                $ZSIQWidgetUI.updateCountUI()
        },
        minimizeSticker: function(e, t) {
            if (!$ZSIQChat.isPreview()) {
                ...
                if (i.sticker[0] != $ZSIQUtil.STATUS_DISABLE && (o = l,
                -1 < m.indexOf("" + o))) {
                    var o;
                    if ("1" == l) {
                        var d = document.getElementById("titlediv");
                        if (a && $ZSIQUtil.containsClass(d, "zsiq_min"))
                            return void (document.getElementById("zsiq_maintitle").innerText = a);
                        d.className = d.className + " zsiq_min"
                    } else {
                        var r = document.getElementById("zsiq_float");
                        if (a && $ZSIQUtil.containsClass(r, "zsiq_min"))
                            return void (document.getElementById("zsiq_maintitle").innerText = a);
                        g.innerHTML = S(I.getFloatButtonHTML($ZSIQWidget.getWidgetObject())),
                        g.className = f(i) + u[$ZSIQWidgetUI.getWidgetPosition()],
                        $ZSIQUtil.bindClickEvent(g, $ZSIQChatWindow.openChatWindow),
                        e && $ZSIQWidgetUI.addClass(g, "zsiqfanim"),
                        function() {
                            var e = $ZSIQWidgetUI.getWidgetPosition();
                            if (5 == e || 11 == e) {
                                var t = document.getElementById("zsiq_float")
                                  , i = -(t.offsetWidth - t.offsetHeight) / 2 + "px";
                                $ZSIQWidgetUI.addClass(g, "zsiq_rotate90"),
                                5 != e ? g.style.right = i : g.style.left = i
                            }
                        }()
                    }
                    var c = document.getElementById("zsiq_float");
                    c && (c.parentElement.style.height = $ZSIQUtil.getElementHeight(c) + "px",
                    c.parentElement.className += " siq_noanim"),
                    t || $ZSIQWidgetUI.setWidgetState($ZSIQWidgetUI.F_BUTTON),
                    $ZSIQWidgetUI.updateCountUI()
                }
            }
        },
        isStickerMinimized: function() {
            if ("1" != $ZSIQWidget.getWidgetObject().sticker[1].default)
                return $ZSIQUtil.containsClass(document.getElementById("zsiq_float"), "zsiq_min");
                ...
                if (e)
                    if ("hide" != e || t && -1 != t) {
                        if ("show" == e) {
                            ...
                            (!i || "block" !== i.style.display || i.style.top.replace("px", "") < 0 || -1 == i.className.indexOf("siqanim")) && (g.style.display = "block",
                            g.className = g.className.replace(/(?:^|\s)zsiqfanim(?!\S)/, ""))
                        } else if (!isNaN(e) && 0 < e) {
                            if (-1 == e)
                                return;
        ...
        handleMinimizeCall: function() {
            ...
            $ZSIQChatWindow.getChatWindowDiv().className += "theme5" === $ZSIQUtil.getIframe().CallImpl.getTheme() ? " siq-calthemesign" : " siq-calthememin"
        },
        handleMinCall: function() {
            this.removeCallClass(),
            $ZSIQChatWindow.getChatWindowDiv().className += "theme5" === $ZSIQUtil.getIframe().CallImpl.getTheme() ? " siq-calthemesign" : " siq-caltheme"
        },
        handlefbCall: function() {
            this.removeCallClass(),
            $ZSIQChatWindow.getChatWindowDiv().className += "theme5" === $ZSIQUtil.getIframe().CallImpl.getTheme() ? " siq-calthemesign" : " siq-calthemefb"
        },
        ...
        updateCount: function(e) {
            ...
            1 == t[0] && "8" == t[1].default && (document.getElementById("zsiq_chatbtn").style.display = "none"),
            document.getElementById("zsiq_unreadcnt") && e && (document.getElementById("zsiq_unreadcnt").style.display = "",
            $ZSIQUtil.setText("zsiq_unreadcnt", e),
            s(!0))
        },
        updateCountUI: function() {
            var e, t = $ZSIQUtil.getIframe(), i = 0;
            if (t && t.$Support)
                i = (e = t.$Support).getUnreadCount(),
                e.setTabOwner();
            else {
            ...
            i ? l == $ZSIQWidgetUI.F_BUTTON ? $ZSIQWidgetUI.updateCount(i) : e && l == $ZSIQWidgetUI.F_WINDOW && !e.isConversationUIFocussed() && ($ZSIQWidgetUI.removeUnreadCount(),
            e.removeUnreadCookie && e.removeUnreadCookie()) : $ZSIQWidgetUI.removeUnreadCount()
        },
        handleFloatEvents: function(e) {
            var t = e.target;
            if ("siqico-close" == t.getAttribute("class"))
                return $zoho.salesiq.floatbutton.coin.hidetooltip(),
                void $ZSIQLSDB.storeInLocalStorage("isTooltipClosed", !0);
            if ("hide-widget" == t.getAttribute("id"))
                return e.stopPropagation(),
                void $zoho.salesiq.floatbutton.visible("hide");
                ...
                if (i) {
                    if (!$ZSIQChat.isPreview() && i.$Support) {
                        ...
                        if (l == $ZSIQWidgetUI.F_BUTTON || l == $ZSIQWidgetUI.F_STICKER || n) {
                            ...
                            a.ispostloaddone || (clearTimeout(a.jsdownloadtimer),
                            a.downloadAdditionalFiles()),
                            $ZSIQWidget.handleCallBacks({
                                "chatbutton.click": ""
                            }),
                            $ZSIQChatWindow.openChatWindow(),
                            window._IS_REVAMP && ("click" == $zv.chatmode ? IframeHandler.sendPostMessage("chatmode") : $zv.question && IframeHandler.sendPostMessage("question"))
                        }
                    }
                } else
                    $ZSIQChatWindow.populateIframe(null, function() {
        ...
        checkWidgetVisibility: function(e) {
            ...
            if (!i || $ZSIQChat.isPreview() || "hide" != i && "show" != i && isNaN(i))
                if ("1" == t.mdevice_hide[0] && $ZSIQWidgetUI.isHandHeldDevice())
                    g.style.display = "none";
                else {
                    if ("1" == t.hideoffline[0] && !$ZSIQChatWindow.getWidgetStatus() || 0 == t.islivechat && !$ZSIQChatWindow.isOnlyCall() || t.hideembed) {
                        if (!e && !$ZSIQChatWindow.isChatExist())
                            return $ZSIQWidgetUI.setWidgetState("0"),
                            void (g.style.display = "none");
                        g.style.display = "block"
                    } else
                        g.style.display = "block";
                    l == $ZSIQWidgetUI.F_WINDOW ? ($ZSIQWidgetUI.minimizeSticker(null, !0),
                    $ZSIQWidgetUI.addClass(g, "zsiqfanim")) : l == $ZSIQWidgetUI.F_BUTTON && $ZSIQWidgetUI.minimizeSticker()
                }
            else
                $ZSIQWidgetUI.handleWidgetVisible(i)
        },
        bindCustomCSS: function(e) {
            ...
            s.id = "zsiqcustomcss",
            s.setAttribute && s.setAttribute("data-id", "zsalesiq"),
            a && s.setAttribute("nonce", a),
            s.appendChild(document.createTextNode(i.getCustomCSS(e))),
            document.body.appendChild(s)
        },
        ...
        bindDragEvent: function() {
            var o, d, r = g, e = r.querySelector("img"), c = !1;
            function t(e) {
                var t, i;
                e.preventDefault(),
                "touchmove" === e.type ? (t = e.touches[0].clientX - o,
                i = e.touches[0].clientY - d,
                c = !0) : (t = e.clientX - o,
                i = e.clientY - d);
                ...
                r.style.left = Math.max(t, s) + "px",
                r.style.top = l + "px"
            }
            r.setAttribute("draggable", !0),
            e && e.setAttribute("draggable", !1),
    ...
    return {
        init: function(t) {
            ...
            !function(t) {
                for (var e in t)
                    i[e] = a(t[e]);
                $ZSIQAnalytics = i.analytics,
                $ZSIQAutopick = $zv.autopick || i.autopick,
                _ZSIQ.brandname = i.brandname
            }(e.widgetobj),
            function(t) {
                for (var e in t)
                    n[e] = a(t[e])
            }(e.embedobj),
            $ZSIQChat.server_avuid = $ZSIQUtil.getAvuid(),
            $ZSIQWidgetUI.initWidgetState(),
            $ZSIQWidgetUI.drawWidget(),
            !$ZSIQChat.isPreview() && $zohosq.init && $zohosq.init(),
            t || $ZSIQUtil.storeDetails(e),
            $ZSIQUtil.manageCookie && $ZSIQUtil.setTrackingStatus()
        },
        ...
        setWidgetCookie: function(t) {
            clearTimeout(e),
            $ZSIQUtil.storeCookieVal("state", t, !0),
